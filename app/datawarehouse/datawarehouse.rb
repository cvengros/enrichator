...
class Datawarehouse
  ...
  def rename_table(old_name, new_name)
    execute(SQLGenerator.rename_table(old_name, new_name))
  end

  def drop_table(table_name, opts={})
    execute(SQLGenerator.drop_table(table_name,opts))
  end
  ...
  def load_data_from_csv(table_name, csv_path, opts={})
    ...
    execute(SQLGenerator.load_data(table_name, csv_path, columns))
  end
  ...
  def create_table(name, columns, options={})
    execute(SQLGenerator.create_table(name, columns, options))
  end
